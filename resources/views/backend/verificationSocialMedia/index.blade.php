                         ...
                         <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                            <thead>
                                <tr class="nk-tb-item nk-tb-head">
                                    ...
                                    <th class="nk-tb-col"><span>Verification Type</span></th>
                            ...
                            <tbody>
                                ...
                                <tr class="nk-tb-item">
                                    ...
                                    <td class="nk-tb-col">
                                        <span class="tb-sub"> {{ $value->social_type }}</span>
                                    </td>   


                                    <td class="nk-tb-col">
                                          @if($value->social_type == 'linkedin')
                                                                        <span class="tb-sub">   
                                                                            @if($value->linkedin_verify == 1)
                                                                            <span class="tb-status text-success">Verified</span>  
                                                                            @elseif($value->linkedin_verify == 0) 
                                                                        ...
                                                                        @elseif($value->social_type == 'facebook')

                                                                        <span class="tb-sub"> 
                                                                            @if($value->facebook_verify == 1)
                                                                            <span class="tb-status text-success">Verified</span>  
                                                                            @elseif($value->facebook_verify == 0) 
                                                                            <span class="tb-status text-warning">Not Verified</span>     
                                                                            @else
                                                                            <span class="tb-status text-danger">Rejected</span>                                              

                                                                        @endif</span>
                                                                        @elseif($value->instagram_verify == 'instagram')

                                                                        <span class="tb-sub">   
                                                                            @if($value->instagram_verify == 1)
                                                                            <span class="tb-status text-success">Verified</span>  
                                                                            @elseif($value->instagram_verify == 0) 
                                                                            <span class="tb-status text-warning">Not Verified</span>     
                                                                            @else
                                                                            <span class="tb-status text-danger">Rejected</span>                                              
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                                          <li><a href="{{action('backend\VerificationsSocialMedia@show', $value->user_id)}}"><em class="icon ni ni-eye"></em><span>View verification</span></a></li>
