                       ...
                       <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                        <thead>
                            <tr class="nk-tb-item nk-tb-head">
                                ...
                                <th class="nk-tb-col"><span>Verification</span></th>
                                <th class="nk-tb-col"><span>Registered Date</span></th>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                 <ul class="link-list-opt no-bdr">
                                                     <li><a href="{{action('backend\UserController@show', $value->users__id)}}"><em class="icon ni ni-speed"></em><span>View/Edit Profile</span></a></li>

                                                     <li><a href="{{url('admin/temporary-suspend')}}/{{ $value->users__id }}"><em class="icon ni ni-speed"></em><span>Temporary Suspend</span></a></li>

                                                      <li><a href="{{url('admin/user/temporary-disable')}}/{{ $value->users__id }}"><em class="icon ni ni-speed"></em><span>Disable</span></a></li>

                                                     <!--  <li><a href="{{action('backend\UserController@edit', $value->users__id)}}"><em class="icon ni ni-edit"></em><span>Edit</span></a></li> -->
                                                     <li>  <a href="{{url('admin/delete-user')}}/{{ $value->users__id }}" onclick="return confirm('Are you want to permanently delete this user ?')"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>

                                                     <li><a href="{{url('admin/user-premium')}}/{{ $value->users__id }}"><em class="icon ni ni-speed"></em><span>Premium </span></a></li>
