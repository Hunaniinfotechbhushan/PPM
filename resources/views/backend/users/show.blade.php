    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                {!! Form::model($users, ['method' => 'PATCH', 'action' => ['backend\UserController@update',$users->user_id],'files'=>true]) !!}
                                                            ...
                                                            <div class="profile-ud-item">
                                                                ...
                                                                <div class="profile-ud-item">
                                                                    <div class="profile-ud wider">
                                                                        ...
                                                                        <span class="profile-ud-value">                 {!! Form::select('is_verified',['Awaiting Approval','Approved','Rejected'], null,  ['class' => 'form-control']) !!}
                                                                        </span>
                                                                    </div>
                                                                </div>
