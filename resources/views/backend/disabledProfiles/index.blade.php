                       ...
                       <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                        <thead>
                            <tr class="nk-tb-item nk-tb-head">
                                ...
                                <th class="nk-tb-col"><span>Disabled Date</span></th>
                        ...
                        <tbody>
                            ...
                            <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col">
                                    <span class="tb-lead">{{ date('d M Y', strtotime($value->disable_profiles)) }}</span>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                 <ul class="link-list-opt no-bdr">
                                                     ...
                                                     <li><a href="{{url('admin/user-rejected-profile/reinstate')}}/{{ $value->users__id }}"><em class="icon ni ni-speed"></em><span>Reinstate </span></a></li>
