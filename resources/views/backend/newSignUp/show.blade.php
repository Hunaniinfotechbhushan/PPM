    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">New Sign Up / <strong class="text-primary small">{{ $users->username }}</strong></h3>
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ url('admin/new-signup') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>

                            <!-- <a href="" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><i class="icon-edit"></i> Edit</span></a> -->
                ...
                {!! Form::model($users, ['method' => 'PATCH', 'action' => ['backend\NewSignUpController@update',$users->user_id],'files'=>true]) !!}
                                        ...
                                        <div class="nk-block-head">
                                            ...
                                            <div class="user-image-section">
                                                ...
                                                @if(isset($users->profile_picture))
                                                  <a href="{{ url('/') }}/media-storage/users/{{ $users->user_Uid }}/{{ $users->profile_picture }}" class="glightbox4">
                                                    <img src="{{ url('/') }}/media-storage/users/{{ $users->user_Uid }}/{{ $users->profile_picture }}" style="max-width: 109px;">
                                                </a>
                                                @else

                                                    <!-- <img src="{{ url('/') }}/imgs/no_thumb_image.jpg" style="max-width: 109px;"> -->
                                        ...
                                        <div class="profile-ud-list">
                                                       <!--      <div class="profile-ud-item">
                                                            ...
                                                            <div class="profile-ud-item">
                                                                ...
                                                                <span class="profile-ud-value"> {!! Form::text('username', null, ['class' => 'form-control username-input-field', 'id' => 'username']) !!}</span>
                                                                </div>
                                                            ...
                                                            <div class="profile-ud-item">
                                                                ...
                                                                <div class="profile-ud-item">
                                                                    <div class="profile-ud wider">
                                                                        ...
                                                                        <span class="profile-ud-value">                {!! Form::select('is_verified',['Awaiting Approval','Approve','Rejected'], null,  ['class' => 'form-control']) !!}
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="profile-ud-item">
                                                                    <div class="profile-ud wider">
                                                                        ...
                                                                        <span class="profile-ud-value text-center">       {!! Form::submit('Submit', ['class' => 'btn btn-primary waves-effect form-submit-btn','id'=>'pagesubmit']) !!}
                                                                        </span>
                                                                    </div>
                                                                </div>
                                ...
                                $.ajax({
                                  ...
                                  success:function(data){
                                    ...
                                    if(data.avaliable == true){
                                        ...
                                        $('.form-submit-btn').removeClass('btn-opecity-profile');
                                      ...
                                      $('.form-submit-btn').addClass('btn-opecity-profile');
