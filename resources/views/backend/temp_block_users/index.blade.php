...
<div class="nk-content">
                         ...
                         <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                            <thead>
                                <tr class="nk-tb-item nk-tb-head">
                                    ...
                                    <th class="nk-tb-col"><span>Sign up date</span></th>
    ...
    @forelse($userData as $key=>$value)
                    ...
                    <td class="nk-tb-col">
                                        ...
                                        <td class="nk-tb-col">
                                            <span class="tb-sub">{{ $value->email }}</span>@if($value->is_email_verified)<em class="icon text-success ni ni-check-circle"></em> @endif
                                        </td> 
                                        ...
                                        <td class="nk-tb-col">
                                           ...
                                           <td class="nk-tb-col">
                                            <span class="tb-sub">{{ \Illuminate\Support\Str::limit($value->city, 10, $end='...') }}</span>
                                        </td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                       <ul class="link-list-opt no-bdr">
                                                                     <li><a href="{{url('admin/temp-user/activate')}}/{{ $value->users__id }}"><em class="icon ni ni-speed"></em><span>Activate </span></a></li>

                                                                       <a href="{{url('admin/temp-user/delete')}}/{{ $value->users__id }}" onclick="return confirm('Are you want to permanently delete this user ?')"><em class="icon ni ni-trash"></em><span>Delete</span></a>
