                       ...
                       <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                        <thead>
                            <tr class="nk-tb-item nk-tb-head">
                                ...
                                <th class="nk-tb-col"><span>Date Even was Created</span></th>
                                        ...
                                        <li class="me-n1">
                                            <div class="dropdown">
                                               ...
                                               <ul class="link-list-opt no-bdr">
                                                           <li><a href="{{url('admin/event/reinstate')}}/{{ $value->_id }}"><em class="icon ni ni-globe"></em><span>Reinstate</span></a></li>

                                                           <a href="{{url('admin/event/remove-from-system')}}/{{ $value->_id }}" onclick="return confirm('Are you want to permanently delete this event ?')"><em class="icon ni ni-trash"></em><span>Remove from system</span></a>
                                                       </ul>
                                                   </div>
                                             </div>
                                         </div>
