        ...
        <div class="form-group">
         ...
         <label for="email_address">Location</label>
          ...
          <div class="form-group">
            <div class="form-line">
                {!! Form::select('user_account',['Standard','Premium' ], null,  ['class' => 'form-control']) !!}
         ...
         <label for="email_address">Approval</label>
          <div class="form-group">
            <div class="form-line">
                {!! Form::select('desc_verified',['Rejected','Approved'], null,  ['class' => 'form-control']) !!}
             @if ($errors->has('desc_verified'))
             <p style="color:red;">
              {!!$errors->first('desc_verified')!!}
            </p>
            @endif
          </div>
        </div>
