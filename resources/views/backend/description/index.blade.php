...
<div class="nk-content">
                         ...
                         <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                            <thead>
                                <tr class="nk-tb-item nk-tb-head">
                                    ...
                                    <th class="nk-tb-col tb-col-sm"><span>Username</span></th>
    ...
    <td class="nk-tb-col">
                                   ...
                                   <td class="nk-tb-col">
                                    ...
                                    <td class="nk-tb-col">
                                        <span class="tb-sub">Approval</span>
                                    </td>  
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                       <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{action('backend\DescriptionController@show', $value->users__id)}}"><!-- <em class="icon ni ni-eye"> --></em><span>View/Edit Profile</span></a></li>
                                                          <!--  <li><a href="{{action('backend\DescriptionController@show', $value->users__id)}}"><em class="icon ni ni-eye"></em><span>View</span></a></li>

                                                           <li><a href="{{action('backend\DescriptionController@edit', $value->users__id)}}"><em class="icon ni ni-edit"></em><span>Edit</span></a></li> -->
