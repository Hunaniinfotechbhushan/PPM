                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Description / <strong class="text-primary small">{{ $users->username }}</strong></h3>
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ url('admin/description') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                    ...
                    {!! Form::model($users, ['method' => 'PATCH', 'action' => ['backend\DescriptionController@update',$users->user_id],'files'=>true]) !!}
                                                            ...
                                                            <div class="profile-ud-item">
                                                                <div class="profile-ud wider">
                                                                    ...
                                                                    <div class="profile-ud wider">
                                                                     ...
                                                                     <div class="profile-ud-item">
                                                                    <div class="profile-ud wider">
                                                                        <span class="profile-ud-label">Seeking</span>
                                                                        <span class="profile-ud-value">{!! Form::textarea('heading', null, ['class' => 'form-control', 'id' => 'heading']) !!}</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="profile-ud-item">
                                                                    <div class="profile-ud wider">
                                                                        ...
                                                                        <span class="profile-ud-value">                 {!! Form::select('desc_verified',['Rejected','Approved'], null,  ['class' => 'form-control']) !!}
