...
<div class="row">
	<div class="col-xl-12">
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<!-- Edit Button -->				
												<a class="dropdown-item" href="{{ url('/')}}/admin/approve/photto/{{ $value->media_id }}"><i class="fa fa-check"></i> <?= __tr('Approve') ?></a>

												<a class="dropdown-item" href="{{ url('/')}}/admin/reject/photto/{{ $value->media_id }}"><i class="fa fa-ban"></i> <?= __tr('Reject') ?></a>
											</div>
										</div></td>
									</tr>
									@empty
		...
		<script>
			...
			{
				var id = id;
				var url = '{{ route("member-media.destroy", ":_id") }}';
