<?php 
$firstParaMsg = ("You're just one step away. Activate your account and set your password now to get relationships on your terms.");
?>
	...
	<tbody>
		...
		<tr style="font-family: Helvetica, Arial, sans-serif;">
			<td class="button" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 30px 0; text-align: center;">
				...
				<a href="<?php echo  $url;?>" style="-webkit-text-size-adjust: none; background-color: #d2009c; border-radius: 5px; color: #ffffff; display: inline-block; font-family: 'Cabin', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: regular; line-height: 45px; mso-hide: all; text-align: center; text-decoration: none !important; width: 155px;"><?= ( 'Activate Account' ) ?></a></div>
			</td>
		</tr>
		<tr style="font-family: Helvetica, Arial, sans-serif;">
