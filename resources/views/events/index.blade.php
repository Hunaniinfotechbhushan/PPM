...
<div id="wrapper" class="container-fluid">
    ...
    <ul class="navbar-nav sidebar  accordion" id="accordionSidebar">
        ...
        <li class="nav-item mt-2 d-sm-block d-md-none">
            ...
            <a href class="nav-link" onclick="getChatMessenger('user/messenger/all-conversation', true)"
                id="lwAllMessageChatButton" data-chat-loaded="false" data-toggle="modal" data-target="#messengerDialog">
        ...
        <li class="nav-item dropdown no-arrow mx-1 d-sm-block d-md-none">
            ...
            <a class="nav-link dropdown-toggle lw-ajax-link-action" href="user/notifications/read-all-notification"
                data-callback="onReadAllNotificationCallback" id="alertsDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false" data-method="post">
    ...
    <div id="content-wrapper" class="d-flex flex-column lw-page-bg">
        ...
        <div id="content">
            ...
            <div class="modal fade" id="boosterModal" tabindex="-1" role="dialog" aria-labelledby="boosterModalLabel"
                aria-hidden="true">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-success btn-sm lw-ajax-link-action" data-callback="onProfileBoosted"
                                href="user/boost-profile" data-method="post"><i class="fas fa-bolt fa-fw"></i> Boost</a>
            ...
            <div class="modal fade add-evnt-modal" id="addEventPopup" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <hr />
                        <form class="userPhottoFormEvent" id="userPhottoFormEvent" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="searchTextField-popup" type="text" name="location" class="map-input"
                                        value="{{ (isset($selectedFilter['location'])) ? $selectedFilter['location'] : '' }}"
                                ...
                                <div class="form-group privacy" style="display: none;">
                                    <label class="event-label" for="display-name"><a href="#" onclick="togglePopup()">
                                        Privacy asdsadsad (stop these users from seeing your event)</a></label>
                                    <select class="select2 select2-hidden-accessible" name="block_user[]" multiple=""
                                        style=" clip: unset !important;
                                        height: 68px !important;
                                        overflow-y: scroll !important;
                                        padding: 0 !important;
                                        width: 100% !important;
                                        ...
                                        ?>
                                        <option data-select2-id="<?php echo $value['_id']; ?>"
                                            value="<?php echo $value['_id']; ?>"><?php echo $value['username'];     ?>
                                        </option>
                                        <?php
                                        //} 
     ...
     <div class="uploaded-img">
         <img id="blah" src="" >
                            ...
                            <div class="modal-footer border-top-0 d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-danger userPhottoCancelBtn c-btn"
            ...
            <div class="modal fade" id="lwDeleteAccountModel" tabindex="-1" role="dialog"
                aria-labelledby="messengerModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="user lw-ajax-form lw-form" method="post" action="user/delete-account">
                                ...
                                Are you sure you want to delete your account? All content including photos and other
                                ...
                                <button type="submit"
                                    class="lw-ajax-form-submit-action btn btn-primary btn-user btn-block-on-mobile">Delete
                                    Account</button>
            ...
            <div class="lw-page-content px-2">
                ...
                <div class="card mb-3 desk-vw">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center filter">
                        ...
                        <h3 class="mb-0">
                            <div class="css-r0xk3p" style="font-size: 0.875rem; color: rgb(126, 126, 126);">About
                                ...
                                <form action="<?= route('user.read.events') ?>">
                                    <div class="dropdown-short">
                                        ...
                                        <select name="short_by" id="selected-short" class="selected-by-short">
                                            ...
                                            <option class="shot_opt <?php echo $AddClass1; ?>" value="newest"
                                                @if(Request::get('short_by')) @if(Request::get('short_by')=='newest' )
                                                selected @endif @endif>Sort By: Newest</option>



                                            <option class="shot_opt <?php echo $AddClass3; ?>" value="nearest"
                                                @if(Request::get('short_by')) @if(Request::get('short_by')=='nearest' )
                                                selected @endif @endif>Sort By: Nearest</option>
                                        </select>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="card mb-3 ">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <button data-toggle="modal" data-target="#addEventPopup" class="web-button">Add
                                Meet</button>
                        </div>
                        @endif
             ...
             <option value="100" @if(Request::get('paginate')) @if(Request::get('paginate') == 100) selected @endif @endif>100 per page</option>
                ...
                <div class="card mb-3 d-md-none event-filter" style="display: none;">
                    ...
                    <ul class="mobile-filter">
                        <li><a class="btn FormFooter-rightLink u-hide--tablet-up js-toggleSidebarBtn css-157uzvc"
            ...
            <div class="row m-0" id="grid_block">
                <div class="col-md-12">
                    ...
                    <a href="<?= route('user.view.events') ?>/?id={{ $filter['_id'] }}">
                        @endif
                        <div
                            class="vister d-flex justify-content-between pb-3  align-items-center-{{$filter['featured']}}">
                            ...
                            <a href="<?= route('user.view.events') ?>/?id={{ $filter['_id'] }}">
                                <div class="img-about d-flex align-items-flex-start" style="width: 100%;">
                                        ...
                                        <div class="slick-carousel mob-vw">
                                            ...
                                            <div class="">
                                                <div class=" vister-profile-image user-img">
                                                    <img width="300px" class="vister-profile-image"
                                                        src="{{ $imgURLpop }}">
                                                </div>
                                            </div>
                                    ...
                                    <div style="width:100%;">
                                        ...
                                        <p class="user-name">{{$filter['title'] }}</p>
                                        ...
                                        <p class=" adress text-gray-600">
                                            {{ isset($filter['location']) ? $filter['location'] : '' }}</p>
                            ...
                            <div>
                                ...
                                <div class="like">
                                    <a href
                                        data-action="<?= route('event.write.like_dislike', ['toUserUid' => $filter['_id'], 'like' => 1]) ?>"
                                        data-method="post" data-callback="onLikeCallback" title="Like"
                                        class="lw-ajax-link-action lw-like-action-btn" id="lwLikeBtn">
...
<script
    src="https://maps.googleapis.com/maps/api/js?key=<?= getStoreSettings('google_map_key') ?>&libraries=places&callback=initialize"
    async defer></script>
...
function onLikeCallback(response) {
    ...
    if (response.reaction == 1 && requestData.likeStatus == 1 && (requestData.status == "created" || requestData
            .status == 'updated')) {
    ...
    if (response.reaction == 1 && requestData.likeStatus == 2 && (requestData.status == "created" || requestData
            .status == 'updated')) {
        __DataRequest.updateModels({
...
for (var i = 0; i <= 60; i++) {
    ...
    $(".drop").append("<option value=" + (date.getDate()) + "-" + (month[date.getMonth()]) + "-" + date.getFullYear() +
        ">" + (date.getDate()) + " " + (month[date.getMonth()]) + " " + date.getFullYear() + "   (" + weekday[date
            .getDay()] + ")</option>");
}
</script>
