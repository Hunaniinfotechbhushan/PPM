 ...
 <li class="nav-item justify-content-between text-left select-drop-down">
    ...
    <div>
      <ul class="filter-ul" id="locationRd">
        ...
        <input id="searchTextFieldTwo" type="text"  name="location" class="map-input" value="{{ (isset($selectedFilter['location'])) ? $selectedFilter['location'] : '' }}" placeholder="Enter a location" autocomplete="on">
      </div>
    </li>
