            ...
            <div class="col-sm-12">
                <div class="profile d-md-none">
                    <div class="vister-profile">
                        ...
                        <span><p>{{ (isset($UserProfile_details['city'])) ? $UserProfile_details['city'] : '' }}</p> </span>
...
<form class="lw-ajax-form lw-form" lwSubmitOnChange method="post" data-show-message="true" action="user/settings/process-basic-settings" data-callback="getUserProfileData" style="display: none;" id="lwUserBasicInformationForm">
    ...
    <div class="form-group row">
        ...
        <div class="col-6 col-sm-6 mb-3 mb-sm-0">
            ...
            <input type="text" value="loveria" class="form-control" name="first_name"
...
<div class="modal fade" id="lwReportUserDialogMessage" tabindex="-1" role="dialog" aria-labelledby="userReportModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <label for="lwUserReportReason">Message</label>
                    <input type="hidden" name="_token" value="">
                   <input type="hidden" class="visitorId" name="visitorId" value="{{ (isset($UserProfile_details['user_id'])) ? $UserProfile_details['user_id'] : '' }}">
                        <textarea name="msg" placeholder="Type a Message" class="message"></textarea>
...
<script>
 ...
 $("#lwBookmarkBtn").on('click', function(e) {
   ...
   ///mobile
     ...
     //Send Message 
   var APP_URL = {!! json_encode(url('/')) !!}
   $("body").on("submit", "#messageBoxFormmobile", function(e) {
    e.preventDefault();
    $.ajaxSetup({
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
