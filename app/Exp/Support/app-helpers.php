...
if (!function_exists('appTimezone')) {
    ...
    if (!function_exists('isCheckAdmin')) {
        function isCheckAdmin()
        {
    ...
    if (!function_exists('getUserDetails')) {
        ...
        {
            return $userDetails = User::where('_id',$userID)->first();
    }
}
  ...
  return false;
    ...
    *-------------------------------------------------------- */
    if (!function_exists('notificationLog')) {
     ...
     if (!function_exists('notificationUserLog')) {
        function notificationUserLog($uid, $slug, $status, $message,$action,$is_read,$users__id,$photo_id)
        {
         NotificationLog::create([
            'uid'    => $uid,
            'photo_id' => $photo_id,
     ...
     if (!function_exists('userActivity')) {
        function userActivity($_uid, $userId, $slug, $activity_log, $status, $event_id )
        {
