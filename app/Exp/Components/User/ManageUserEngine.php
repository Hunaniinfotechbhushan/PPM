...
{   
	...
	*/
    ...
    {
     return $userCollection = $this->manageUserRepository->fetchUsersDataTableSource($status);
   ...
   //                  $imgURL = url('/').'/media-storage/users/'$key['_uid'].'/'.$key['profile_picture'];
...
return $this->dataTableResponse($userCollection, $requireColumns);
    ...
    public function processAddUser($inputData)
    {
      ...
      public function newSignUpListGet() 
    {

     return $userCollection = $this->manageUserRepository->newSignUpListGetDataTable();

 }


    public function prepareUserAllData() 
    {

     return $userCollection = $this->manageUserRepository->fetchUsersDataTable();
...
return $this->engineReaction($transactionResponse);
    ...
    public function processVerifyUserProfile($userUid) 
    {
        ...
        userActivity($userDetails->_uid,$userDetails->_id,'new-user-added','New Profile',1,"");
