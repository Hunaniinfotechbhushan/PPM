...
{    
    ...
    function __construct(ManageUserEngine $manageUserEngine)
    {
        ...
        public function newSignUpList() 
    {

           $userData = $this->manageUserEngine->newSignUpListGet();
    ...
    public function userList($status) 
    {
           ...
           $userData = $this->manageUserEngine->prepareUserAllData();
          return $this->loadManageView('user.manage.list', compact('userData'));
    }   
    ...
    {    
       ...
       return redirect('admin/manage/user/1/list');
