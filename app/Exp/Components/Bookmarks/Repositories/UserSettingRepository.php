...
namespace App\Exp\Components\Bookmarks\Repositories;
...
{ 
    ...
    public function fetchFilterData($filterData, $ignoreUserIds, $paginateCount = false)
    {
        ...
        if(isset($filterData['max_age'])){
           ...
           $minAgeDate = Carbon::today()->subYears(getUserSettings('min_age'))->toDateString();
           $maxAgeDate = Carbon::today()->subYears(getUserSettings('max_age'))->endOfDay()->toDateString();
           $currentDate = Carbon::now();
       }
