...
class TempBlockUserController extends Controller

{
    ...
    {
      return view('backend.temp_block_users.create');
    }
    ...
    public function store(Request $request)
    {
...

     {
       ...
       return redirect('admin/temp_block_users');
    ...
    public function show($id)
    {
      ...
      return view('backend.temp_block_users.show',compact('users'));
...

    {
     ...
     return view('backend.temp_block_users.edit',compact('users'));
  ...
  public function temp_user_activate($id){

   $getUserDetails = getUserDetails($id);
   
   $slug = 'account/temp-suspend';
   $message = 'Your profile is up now.';
   ...
   Session::flash('success','Successfully activated suspend account.');
   return redirect('admin/users');
 }
