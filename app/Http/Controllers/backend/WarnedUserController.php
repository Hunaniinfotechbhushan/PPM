...
class WarnedUserController extends Controller

{
    ...
    public function index()
    {
      ...
      return view('backend.warnUser.index',compact('userData'));
    }
 ...
 public function delete_user($id){
   ...
   return redirect('admin/warned-users');
 }

  public function remove_warm_user($id){
   $user = User::findOrFail($id);
   $user->warn=0;
   $user->updated_at=Carbon::now();
   $user->save();
