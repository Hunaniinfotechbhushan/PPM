...
class UserRejectedProfileController extends Controller

{
    ...
    public function index()
    {
      ...
      return view('backend.users_reject_profile.index',compact('userData'));
    }
    ...
    public function show($id)
    {
      ...
      return view('backend.users_reject_profile.show',compact('users'));
...

    {
     ...
     if( $validation->fails() ) {
       return redirect('/admin/user-rejected-profile/'.$id.'/edit')->withErrors($validation->errors());
     }
     else
     {
      ...
      return redirect('admin/user-rejected-profile');
 ...
 public function reinstate($id){
   ...
   $user->save();
     ...
     // $user->delete();
     // UserProfile::where('users__id',$id)->delete();
   Session::flash('success','Successfully reinstate profile.');
   return redirect('admin/users');
 }
